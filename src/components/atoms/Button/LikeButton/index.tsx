...
export const LikeButton = () => {
  ...
  return (
<svg onClick={toggleButton}className={active ? `${styles.likeButton, styles.clicked}` : `${styles.likeButton}`} width="150px" height="150px" viewBox="0 0 500 500">
  <circle className={active ? `${styles.clickExplosion}` : `${styles.explosion}`}  r="150" cx="250" cy="250"></circle>
  ...
  <path className={active ? `${styles.clickHeart}` : `${styles.heart}`}  d="M250,187.4c-31.8-47.8-95.5-19.8-95.5,32.2c0,35.2,31.8,60.3,55.7,79.2c24.9,19.7,31.8,23.9,39.8,31.8 c7.9-7.9,14.6-12.6,39.8-31.8c24.3-18.5,55.7-44.4,55.7-79.6C345.5,167.6,281.8,139.7,250,187.4z"/>
</svg>
  )
}